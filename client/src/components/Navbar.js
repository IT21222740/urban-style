            ...
            <nav className="navbar navbar-expand-lg shadow-lg p-3 mb-5 navbar-dark bg-black  fixed-top">
                ...
                <div className="container-fluid">
                    <a class="navbar-brand" href="/">
                        <img src="https://i.ibb.co/Wx1x48r/icon2-drawio.png" alt="" width="100" height="35" class="d-inline-block align-text-top" />
                    </a>
                        ...
                        <ul className="navbar-nav ms-auto">
                            ...
                            <li className="nav-item mt-1">
                                <a className="nav-link " href="/">
                                    <i class="fa-solid fa-item-slice fa-beat" style={{ fontSize: '15px', color: 'white' }} ></i><> </><h16>Clothing</h16>
                                </a>
                            </li>
                            <li className="nav-item mt-1">
                                <a className="nav-link " href="/footwares">
                                    <i class="fas fa-beat" style={{ fontSize: '18px', color: 'white', paddingLeft: "0px" }} ></i><> </><h16 style={{ paddingRight: "0px" }}>Footware</h16>
                                </a>
                            </li>
