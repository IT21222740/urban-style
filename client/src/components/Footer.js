            ...
            <div class="container" >
                <footer class="py-5" >
                    <div class="row">
                        <div class="col-6 col-md-2 mb-3">
                            ...
                            <ul class="nav flex-column">
                                ...
                                <a href="/">
                                    <img src="" alt="" width="110" height="65" class="d-inline-block align-text-top" />
                                </a>
                                <br/>
                    ...
                    <div>
                       ...
                       <hr/>
                        <p className='text-end'>© 2023 Urban-Styles, Inc. All rights reserved.</p>
                       
                    </div>
                    {/* <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                        <p>© 2022 Urban-Styles, Inc. All rights reserved.</p>
