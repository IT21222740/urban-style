...
import Itemcataloguescreen from "./screens/Itemcataloguescreen";
    ...
    <div className="App">
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/footwares" exact element={<Beveragesscreen />} />
          ...
          {currentAdmin ? (
            <Route
              path="admin/additemcatalogue"
              exact
              element={<Itemcataloguescreen />}
            />
          ) : (
            <Route path="/error" exact element={<Errorscreen />} />
          )}
