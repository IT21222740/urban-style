        ...
        <div>
            ...
            <div className='row justify-content-center '>
                ...
                <div class="card col-md-4 m-4 shadow p-3 mb-5 bg-white" style={{ width: '18rem', borderRadius: '15px' }}>
                    <img src="https://img.freepik.com/free-vector/people-ordering-item-cafe-online_74855-5913.jpg?w=996&t=st=1672324604~exp=1672325204~hmac=529755ba63bdfa1b037ddba4d350aaa4d2d177bf57fec2d01767f3daf5af4ce8" class="card-img-top" alt="..." />
                    <div class="card-body">
                ...
                <div className='row justify-content-center '>
                    ...
                    <div class="card col-md-4 m-4 shadow p-3 mb-5 bg-white " style={{ width: '18rem', borderRadius: '15px' }}>
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Item Catalogue and NewsFeed Management
                            </h5>
                    ...
                    <div class="card col-md-4 m-4 shadow p-3 mb-5 bg-white " style={{ width: '18rem', borderRadius: '15px' }}>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">-Manage all the stocks(reports about items such as ingredients,footwares..)<br></br>
