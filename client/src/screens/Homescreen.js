...
export default function Homescreen() {
    ...
    const filteredItems = Items.filter(item => {
        if (selectedOption === 'top') {
            return item.name.toLowerCase().includes(searchQuery.toLowerCase()) && !item.isPants && item.isTop;
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="https://lurreli.lk/cdn/shop/files/Paradise_Escape_Cover.jpg?v=1690978397&width=2000" className="d-block w-100" alt="..." />
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    ...
                                    <div class="p-3" >
                                        ...
                                        <label className="p-2">
                                            <input type="radio" value="pants" checked={selectedOption === 'pants'} onChange={handleOptionChange} />
                                        ...
                                        <label className="p-2">
                                            <input type="radio" value="footware" checked={selectedOption === 'footware'} onChange={handleOptionChange} />
                                        ...
                                        <div class="carousel-caption" style={{ postition: 'absolute' }}>
                                            ...
                                            <div class="row text-center">
                                                ...
                                                <div class="col-md-4 mb-0">
                                                    ...
                                                    <p class="px-xl-3" >
                                                        <i class="fas fa-quote-left pe-2"></i>Hurry Up Itemies!!! Give Us  Your Valuable Feedback...
                                                    </p>
            ...
            <a href="/feedback"><div className="position-fixed bottom-0 end-1" style={{ paddingBottom: '50px', paddingLeft: '25px' }}>
                ...
                >
                    ...
                    <button className="btn rounded-circle shadow-lg " variant="success" style={{
                        ...
                        height: '60px',
                        borderRadius: '60px'
                    }} ><i className="fa-solid fa-item-slice" style={{ fontSize: '25px' }} ></i></button>
